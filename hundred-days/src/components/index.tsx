...
export function StatusBar({ gameState }: { gameState: GameState }) {
  ...
  return (
    <View style={{ backgroundColor: '#1A1208', flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#2D1F0A' }}>
      {/* Day */}
      <StatusPill
        label="DAY"
      ...
      />
      {/* Location */}
      <StatusPill label="LOC" value={String(gameState.currentLocationId)} />
      {/* Food */}
      <StatusPill
        label="FOOD"

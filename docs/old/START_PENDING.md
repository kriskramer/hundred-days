...
All items in this list have been fully completed.

| Item  | Description                      | Complexity | Status    |
|-------|----------------------------------|------------|-----------|
| 2A    | Stabilize enemy construction     | Low        | Completed |
| 2C    | Combat log height                | Low        | Completed |
| 3A    | Starvation alert                 | Low        | Completed |
| 4C    | Tab navigation labels            | Low        | Completed |
| 1B    | Extended journal logging         | Low        | Completed |
| 2D    | Behavior tooltips                | Low        | Completed |
| 2E    | Level-up stat preview            | Low-med    | Completed |
| 3B    | Rest/Hunt ambush risk            | Low-med    | Completed |
| 3C    | Active weather effects           | Low        | Completed |
| 2B    | Combat item picker               | Medium     | Completed |
| 1C    | Decouple storage from screens    | Medium     | Completed |
| 1A    | Seeded RNG                       | Med-high   | Completed |
